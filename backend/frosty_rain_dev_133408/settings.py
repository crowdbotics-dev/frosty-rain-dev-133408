"""
Django settings for frosty_rain_dev_133408 project.
...
ROOT_URLCONF = 'frosty_rain_dev_133408.urls'
...
WSGI_APPLICATION = 'frosty_rain_dev_133408.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_rain_dev_133408 API",
    "DESCRIPTION": "API documentation for frosty_rain_dev_133408 App",
    "VERSION": "v1",
}
